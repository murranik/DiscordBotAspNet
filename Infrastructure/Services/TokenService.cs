...
namespace Infrastructure.Services
{
    public class TokenService : ITokenService
    {
        ...
        private List<char> substitionTable = new();
        ...
        public TokenService() 
        {
            ...
            substitionBox.ForEach((value) => {
                substitionTable.Add(_alphabet[value]);
            });
        }
        ...
        public string Encrypt(string data) 
        {
            ...
            foreach (var c in data) 
            {
                ...
                var cipheredChar = substitionTable[cipheredCharIndex];
        ...
        public string Decrypt(string cipheredData)
        {
            ...
            {
                var decryptedCharIndex = substitionTable.FindIndex(x => x == c);
